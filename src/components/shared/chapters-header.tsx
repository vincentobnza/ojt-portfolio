  ...
  return (
    <div className="w-full p-5" id={id}>
      <Link
        ...
        className="flex items-start gap-3 text-sm font-medium py-6 opacity-60 hover:opacity-100 hover:text-violet-500 transition-colors duration-200 cursor-pointer"
      >
        <ChevronLeft size={21} />
        Quick Overview
      </Link>
